...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        //2.Task - new field added
        int sleepTimeInMiliseconds;

        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepTimeInMiliseconds = 100)
        {
            ...
            this.sleepTimeInMiliseconds = sleepTimeInMiliseconds;
        }
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(sleepTimeInMiliseconds);
